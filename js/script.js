...
function hitungKeliling(){
    ...
    if(Number(sisiLuas)){
        document.getElementById("output_keliling").innerHTML = '<br><p class="output">K = 4 x S<br>K = 4 x '+sisiLuas+'<br>K = '+sisiLuas*4+'</p>';//If the input is number then dispalay square circumference calculation
    }else if(sisiLuas == 0){
